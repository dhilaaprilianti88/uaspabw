        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Barang</h1>
                    <p class="mb-4"></p>
                    <div class="mb-4">
	                ...
	                <form action="<?= site_url('admin/crud_barang/updatebarang/') ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <input type="hidden" name="oldPict" value="<?= $br->photo_barang ?>">
                                
                                    <p> Nama Barang <br> 
                                    <input class="form-control form-control-user" input type="text" name="nama_barang" value="<?php echo $br->nama_barang ?>" >
                                    <p> Jenis Barang <br> 
                                    <input class="form-control form-control-user" input type="text" name="jenis_barang" value="<?php echo $br->jenis_barang ?>">
                                    <p> ID Penerima <br> 
                                    <input class="form-control form-control-user" input type="text" name="jenis_barang" value="<?php echo $br->id_penerima ?>">
                                    <p> Deskripsi<br> 
                                    <input class="form-control form-control-user" input type="text" name="deskripsi" value="<?php echo $br->deskripsi ?>">
                                    <!-- <p> Gambar <br> 
                                    <input class="form-control form-control-user btn btn-primary py-1 px-3 me-2" input type="file" name="photo_barang" value="<?php echo base_url() . '/gambar/'. $br->photo_barang; ?>"> -->
                                    <div class="form-group">
                                    <label>Gambar Tanaman</label>
                                        <div class="custom-file">
                                            <input id="photo_barang" type="file" name="photo_barang" class="custom-file-input form-control"onchange="previewImg()">
                                            <label for="file_event" class="custom-file-label">Pilih File</label>
                                        </div>
                                        <img src="<?= base_url() . '/gambar/'. $br->photo_barang; ?>" alt="" class="preview-img mt-2" width="200px">
                                    </div>
                                    <br><br> <input class="btn btn-primary py-2 px-3 me-2" type="submit" value="Submit">
                                </div>  
                            </div>
                        </div>
                    </form>	
