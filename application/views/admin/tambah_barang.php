...
<body id="page-top">
 ...
 <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url(). 'admin/crud_barang/tambahbarang_aksi'; ?> " enctype="multipart/form-data" method="post">
                        <table style="margin:20px auto;">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <p> Nama Barang <br> 
                                    <input class="form-control form-control-user" input type="text" name="nama_barang" >
                                    <p> Jenis Barang <br> 
                                    <!-- /<input class="form-control form-control-user" input type="text" name="jenis_barang" > -->
                                    <select name="jenis_barang" class="form-control form-control-user">
										<option value=" ">--- Pilih Jenis Barang ---</option>
										<option value="Elektronik">Elektronik</option>
										<option value="Furnitur">Furnitur</option>
                                        <option value="Alat Sekolah">Alat Sekolah</option>
                                        <option value="Alat Sekolah">Perlengkapan Dapur</option>
									</select> 
                                    <p> ID Penerima <br> 
                                    <input class="form-control form-control-user" input type="text" name="id_penerima" >
                                    <p> Deskripsi<br> 
                                    <input class="form-control form-control-user" input type="text" name="deskripsi" >
                                    <p> Foto Barang <br> 
                                    <input class="btn btn-primary py-1 px-2 me-1 form-control form-control-user" input type="file" name="photo_barang" size="20" accept="image/jpg, image/jpeg, image/png"><br>
