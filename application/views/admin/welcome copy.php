    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <a class="nav-link" href=" <?php echo base_url('crud_donatur/lihatdonatur'); ?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Data Donatur</span></a>
                <a class="nav-link active" href=" <?php echo base_url('crud_donasi/lihatdonasi'); ?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Data Donasi</span></a>
                <a class="nav-link" href=" <?php echo base_url('crud_barang/lihatbarang'); ?>">
                    <i class="fas fa-fw fa-table"></i>
