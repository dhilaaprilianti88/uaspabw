...
<body id="page-top">
 ...
 <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url(). 'admin/crud_donatur/tambahdonatur_aksi'; ?> " method="post">
                        <table style="margin:20px auto;">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <p> Nama Donatur <br> 
                                    <input class="form-control form-control-user" input type="text" name="nama_donatur" >
                                    <p> No. Hp <br> 
                                    <input class="form-control form-control-user" input type="text" name="nohp" >
                                    <p> Alamat<br> 
