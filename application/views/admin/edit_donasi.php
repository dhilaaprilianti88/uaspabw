        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
	                ...
	                <form action="<?php echo base_url(). 'admin/crud_barang/updatebarang'; ?>" method="post">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    ...
                                    <p> Foto Barang <br> 
                                    <input class="btn btn-primary py-1 px-2 me-1 form-control form-control-user" input type="file" name="photo_barang" value="<?php echo base_url() . '/gambar/'. $br->photo_barang; ?>"><br>
