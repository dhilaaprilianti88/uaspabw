...
<body id="page-top">
 ...
 <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Donatur</h1>
                    <p class="mb-4">Isi formulir di bawah ini dengan data yang sesuai</p>
                    <div class="mb-4">                    
                    </div>

                    <?php foreach($tb_donatur as $dn){ ?>
                    <form action="<?php echo base_url(). 'admin/crud_donatur/updatedonatur'; ?> " method="post">
                        <table style="margin:20px auto;">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <input type="hidden" name="id_donatur" value="<?php echo $dn->id_donatur ?>">
                                    <p> Nama Donatur <br> 
                                    <input class="form-control form-control-user" input type="text" name="nama_donatur" value="<?php echo $dn->nama_donatur ?>">
                                    <p> No. Hp <br> 
                                    <input class="form-control form-control-user" input type="text" name="nohp" value="<?php echo $dn->nohp ?>">
                                    <p> Alamat<br> 
                                    <input class="form-control form-control-user" input type="text" name="alamat" value="<?php echo $dn->alamat ?>">
